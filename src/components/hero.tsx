      ...
      <div className="max-w-3xl">
        ...
        <div className="flex gap-4 mt-8">
          <a 
            ...
            className="w-20 h-9 flex items-center justify-center border border-gray-400 rounded-full hover:scale-105 hover:translate-x-1 hover:border-white transition-all duration-300"
            aria-label="GitHub"
          >
          ...
          <a 
            ...
            target="_blank" 
            rel="noopener noreferrer"
            className="w-24 h-9 flex items-center justify-center border border-gray-400 rounded-full hover:scale-105 hover:translate-x-1 hover:border-white transition-all duration-300"
            aria-label="LinkedIn"
          >
