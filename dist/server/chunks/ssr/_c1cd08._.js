...
var __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$client$2f$app$2d$dir$2f$link$2e$js__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__ = __turbopack_import__("[project]/node_modules/next/dist/client/app-dir/link.js [app-ssr] (ecmascript)");
var __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$data$2f$blogs$2e$ts__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__ = __turbopack_import__("[project]/src/data/blogs.ts [app-ssr] (ecmascript)");
'use client';
;
;
;
...
function Portfolio() {
    const [projectsWithBlogUrls, setProjectsWithBlogUrls] = (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$server$2f$route$2d$modules$2f$app$2d$page$2f$vendored$2f$ssr$2f$react$2e$js__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["useState"])([]);
        ...
        const fetchProjectBlogs = async ()=>{
            try {
                const projectsWithUrls = await Promise.all(projects.map(async (project)=>{
                    const projectBlog = await (0, __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$data$2f$blogs$2e$ts__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["getProjectBlog"])(project.id);
                    return {
                        ...project,
...
"[project]/src/components/3d-background.tsx [app-ssr] (ecmascript)": ((__turbopack_context__) => {
"use strict";
...
//# sourceMappingURL=_c1cd08._.js.map